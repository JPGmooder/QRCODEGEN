              ...
              SizedBox(
                  ...
                  child: NeumorphicButton(
                    ...
                    style: NeumorphicStyle(
                        ...
                        color: isReaded ? Colors.green[300] : Colors.grey[300]),
                    onPressed: () =>
                        isReaded ? Navigator.of(context).pop(true) : null,
                    child:
                        FittedBox(fit: BoxFit.contain, child: Text("Принять")),
                  )),
              SizedBox(
                width: size.width > 800 ? size.width * 0.1 : size.width * 0.25,
                height: size.width > 800
                    ? size.width * 0.05
                    : size.width > 400
                        ? size.width * 0.06
                ...
                child: NeumorphicButton(
                  style: NeumorphicStyle(
                      color: Colors.red[300], shape: NeumorphicShape.convex),
                  onPressed: () => Navigator.of(context).pop(false),
                  child:
                      FittedBox(fit: BoxFit.contain, child: Text("Отклонить")),
                ),
              )
            ],
          ),
...
//                         primary:
//                             isReaded ? Colors.green[300] : Colors.grey[300]),
//                     onPressed: () => isReaded
